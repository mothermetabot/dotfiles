...
# --- prompt -------------------------------------------------------------------
# Native, no starship. See .config/prompt/prompt.sh; the PowerShell half is
# prompt.ps1 beside it and the two must render identically.
[ -r "$HOME/.config/prompt/prompt.sh" ] && . "$HOME/.config/prompt/prompt.sh"
